...
createPlatform(640, 350, 200, 20);
createPlatform(300, 400, 200, 20);
createPlatform(420, 400,200);
createPlatform(900, 280, 200, 29);
    ...
    createCollectable("kennedi", 850,550);
    ...
    createCannon("right", 750, 2000); // cannon on left wall, 600px down, shooting once per second
